...
func (w *wrappedCommonJS) Instantiate() goja.CyclicModuleInstance {
	return &wrappedCommonJSInstance{w: w} // TODO fix
}
...
func (wmi *wrappedCommonJSInstance) ExecuteModule(rt *goja.Runtime) (goja.ModuleInstance, error) {
	wmi.rt = rt
...
func (wmi *wrappedCommonJSInstance) GetBindingValue(name unistring.String) goja.Value {
	n := name.String()
	if n == "default" {
